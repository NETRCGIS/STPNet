...
parser = argparse.ArgumentParser(
    description='PyTorch video prediction model - STPNet')
...
parser.add_argument('--train_data_paths', type=str, default='data/kth_action')
parser.add_argument('--valid_data_paths', type=str, default='data/kth_action')
parser.add_argument('--save_dir', type=str,
                    default='checkpoints/kth_stp')
parser.add_argument('--gen_frm_dir', type=str,
                    default='results/kth_stp')
...
parser.add_argument('--r_exp_alpha', type=int,
                    default=2000)  # mnist:2500,kth:2000
# scheduled sampling
...
# optimization
parser.add_argument('--lr', type=float, default=0.0001)  # v1 0.003 v2 0.0001
parser.add_argument('--reverse_input', type=int, default=1)
parser.add_argument('--batch_size', type=int,
                    default=4)  # mnist:8,kth:4,bair:16
...
def reserve_schedule_sampling_exp(itr):
    ...
    if itr < args.r_sampling_step_1:
        ...
        eta = 0.5 - (0.5 / (args.r_sampling_step_2 -
                     args.r_sampling_step_1)) * (itr - args.r_sampling_step_1)
    else:
        eta = 0.0
