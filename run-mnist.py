...
parser.add_argument('--save_dir', type=str,
                    default='checkpoints/mnist_stp')
parser.add_argument('--gen_frm_dir', type=str,
                    default='results/mnist_stp')
...
parser.add_argument('--decouple_beta', type=float,
                    default=0.1)  # mnist,bair:0.1,kth:0.01
...
parser.add_argument('--r_exp_alpha', type=int,
                    default=2500)  # mnist:2500,kth:2000
# scheduled sampling
...
parser.add_argument('--batch_size', type=int,
                    default=8)  # mnist:8,kth:4,bair:16
